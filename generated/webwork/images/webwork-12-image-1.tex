...
\begin{tikzpicture}\begin{axis}[
  ...
  \addplot[firstcurvestyle, domain=-6:-4.1, samples=40] {((x^2-13*x-32)/(x^2+8*x+16))};
  \addplot[firstcurvestyle, domain=-3.9:6, samples=40] {((x^2-13*x-32)/(x^2+8*x+16))};
  \addplot[asymptote] coordinates {(-4,-100) (-4,100)};
\end{axis}
