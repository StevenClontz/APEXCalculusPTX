...
\begin{tikzpicture}\begin{axis}[
  ...
  \addplot[firstcurvestyle, domain=-2:-0.01] {((x-5)/(x^2-4*x))};
  \addplot[firstcurvestyle, domain=0.01:3.99] {((x-5)/(x^2-4*x))};
  \addplot[firstcurvestyle, domain=4.01:6] {((x-5)/(x^2-4*x))};
  \addplot[asymptote] coordinates {(0,-25) (0,25)};
  \addplot[asymptote] coordinates {(4,-25) (4,25)};
\end{axis}
