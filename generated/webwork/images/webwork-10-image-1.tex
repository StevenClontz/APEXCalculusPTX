...
\begin{tikzpicture}\begin{axis}[
  ...
  \addplot[firstcurvestyle, domain=-6:4.99] {((x^2+2*x-8)/(x^2-x-20))};
  \addplot[firstcurvestyle, domain=5.01:6] {((x^2+2*x-8)/(x^2-x-20))};
  \addplot[asymptote] coordinates {(5,-3) (5,3)};
  \addplot[hollowdot] coordinates {(-4,0.666666666666667)};
\end{axis}
