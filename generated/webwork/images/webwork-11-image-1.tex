...
\begin{tikzpicture}\begin{axis}[
  ...
  \addplot[firstcurvestyle, domain=-5:-2.01] {((x^2+10*x+21)/(x^2+5*x+6))};
  \addplot[firstcurvestyle, domain=-1.99:0] {((x^2+10*x+21)/(x^2+5*x+6))};
  \addplot[asymptote] coordinates {(-2,-6) (-2,6)};
